      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            Row(
              children: [
                Expanded(child: _statCard("Cycle", "Day ${cycle.cycleDay}", Icons.favorite, Colors.pink)),
                const SizedBox(width: 14),
                Expanded(child: _statCard("Phase", cycle.phase, Icons.spa, Colors.purple)),
              ],
            ),
            const SizedBox(height: 14),
            Row(
              children: [
                Expanded(child: _statCard("Water", "${log.water.toStringAsFixed(1)}L", Icons.water_drop, Colors.blue)),
                const SizedBox(width: 14),
                Expanded(child: _statCard("Sleep", "${log.sleep.toStringAsFixed(1)}h", Icons.bedtime, Colors.indigo)),
              ],
            ),
          ...
          children: [
            ...
            const Expanded(
              child: Column(
                ...
                children: [
                  Text("دورتي", style: TextStyle(fontSize: 28, fontWeight: FontWeight.w900)),
                  SizedBox(height: 4),
                  Text("Dawrati Free Plan", style: TextStyle(color: Colors.grey, fontWeight: FontWeight.w600)),
                ],
              ),
            ),
          ...
          children: [
            ...
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("Dawrati Premium", style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.w900)),
                  SizedBox(height: 6),
                  Text("Unlock AI coach and advanced insights.", style: TextStyle(color: Colors.white70)),
                ],
              ),
            ),
